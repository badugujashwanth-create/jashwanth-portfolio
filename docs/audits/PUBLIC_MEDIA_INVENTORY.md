...
Portfolio source: `jashwanth-portfolio` at `b14dce6`
...
| GitHub release media                 |       42 | HTTP 200; non-zero; API MIME is correct                                   | Download-only; GitHub CDN forces `application/octet-stream` |
...
| Neutro                      | `Neutro/docs/demo/demo.*`                               | `/media/neutro/`                      | 0:55.040 | VP8, no audio | H.264, no audio | 520,039 / 1,894,256 / 395 / 40,486        | Pass                      | Reused; captioned; no fake audio added               |
...
| HYD VNTG                    | `thrifty_vintagegarage/docs/demo/demo.*`                | `/media/hyd-vntg/`                    | 0:58.240 | VP8, no audio | H.264, no audio | 806,351 / 2,103,053 / 408 / 342,511       | Pass                      | Reused; captioned; no fake audio added               |
...
The portfolio, Neutro, ShadowOps, HYD VNTG, and ParkAlert recordings are silent source captures with caption files. This phase did not invent narration or add a deceptive silent audio stream. The user explicitly prohibited new recording in Phase 2.
...
| `/assets/projects/hyd-vntg-storefront.png`         | 342,511 | 1280×720   | `image/png`     | Project image / Repaired from existing poster |
| `/assets/projects/neutro.png`                      |  40,486 | 1280×720   | `image/png`     | Project image / Working                       |
...
The HYD VNTG card previously used a 1280×6541 full-page image inside a fixed frame. It was the only extreme-aspect active image and was replaced with the already-existing 1280×720 demo poster. No screenshot was recorded or generated.
...
| `hyd-vntg-storefront`         | `docs/demo/demo-thumbnail.png`            | `/work/hyd-vntg-storefront/`         | MP4, WebM, VTT             | Working                                         |
